// Vendored from substack/subarg (MIT). Parses argv with nested `[ ... ]`
// sub-arguments, delegating the flat parse to minimist. Inlined to drop the
// abandoned `subarg` dependency; browserify is its only consumer here.
