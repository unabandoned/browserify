...
exports.stream = require.resolve('./vendor/stream.js');
exports._stream_duplex = require.resolve('./_stream_duplex.js');
exports._stream_passthrough = require.resolve('./_stream_passthrough.js');
exports._stream_readable = require.resolve('./_stream_readable.js');
exports._stream_transform = require.resolve('./_stream_transform.js');
exports._stream_writable = require.resolve('./_stream_writable.js');
exports.string_decoder = require.resolve('string_decoder/');
exports.sys = require.resolve('util/util.js');
exports.timers = require.resolve('./vendor/timers.js');
