...
//
// The browserify test suite (test/*.js) was written for tap:
//
...
//
// Async handling (critical — browserify tests are heavily async and spawn child
// processes): tap signals completion via t.end() or by counting down t.plan(n).
